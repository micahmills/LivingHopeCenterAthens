...
function get_each_context(ctx, list, i) {
	...
	child_ctx[8] = list[i].language_name;
	return child_ctx;
}
...
// (110:8) {#each languages as { language_name }}
function create_each_block(ctx) {
	let a;
	let t_value = /*language_name*/ ctx[8].label + "";
	let t;
	let a_href_value;
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-tgfxa0");
			attr(a, "href", a_href_value = /*language_name*/ ctx[8].url);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*languages*/ 4 && t_value !== (t_value = /*language_name*/ ctx[8].label + "")) set_data(t, t_value);

			if (dirty & /*languages*/ 4 && a_href_value !== (a_href_value = /*language_name*/ ctx[8].url)) {
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t2 = claim_text(h1_nodes, /*headline*/ ctx[1]);
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-tgfxa0");
			attr(nav, "class", "svelte-tgfxa0");
			attr(div0, "class", "mobile-nav svelte-tgfxa0");
			attr(div1, "class", "section-container svelte-tgfxa0");
			attr(h1, "class", "headline svelte-tgfxa0");
			attr(div2, "class", "section-container svelte-tgfxa0");
			...
			attr(header, "class", "svelte-tgfxa0");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*headline*/ 2) set_data(t2, /*headline*/ ctx[1]);

			if (dirty & /*background*/ 8) {
				set_style(header, "background-image", "url('" + /*background*/ ctx[3].url + "')");
			}

			if (dirty & /*background*/ 8 && header_aria_label_value !== (header_aria_label_value = /*background*/ ctx[3].alt)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [logo, headline, languages, background, props, site_nav];
}
